...
(The log of $N$, the number of documents in the corpus, divided by the length of the set ($|\{\dots\}|$) of documents that contain the term.)
...
The programming skills we will need will step up a notch. You may want to brush up on your **control structures** in [R](https://www.r-bloggers.com/2019/06/how-to-use-if-else-statements-and-loops-in-r/) or [python](https://docs.python.org/3/tutorial/introduction.html#first-steps-towards-programming) (sections 3.2 to 4.7), as well as **data types and structures** in [R](https://swcarpentry.github.io/r-novice-inflammation/13-supp-data-structures.html) or [python](https://docs.python.org/3/tutorial/datastructures.html#). You will need some of these to complete the next homework assignment.

For content input, have a look at this [fairly recent paper](https://www.thelancet.com/journals/lanplh/article/PIIS2542-5196(22)00173-5/fulltext) on the relationship between temperatures and hate speech.
