...
Using a regular expression, get a list of words spoken in parliament that contain (in upper or lower case) the string "kohle" (coal). Count the occurences of each of these words.
