...
\begin{itemize}
  ...
  \item<3-> Read texts stored in various formats and process 
\end{itemize}
...
We've had a look at 3 different data sources. Pick one, alter the query parameters (if applicable) and try to process it as we did last week. Report on commonly used words in the data. 
