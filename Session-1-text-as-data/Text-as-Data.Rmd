...
### Part 1 (weeks 1-6) - Foundations

In the first part of the course we will encounter a range of different texts, and get comfortable working with these in R

### Part 2 (weeks 7-11) - Analysis

In the following 5 weeks, we will learn 5 different approaches to analysing texts, how to carry these out in R, and how to use and interpret the results
